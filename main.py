"""
VRChat BPlayer Proxy — HLS-only video streaming proxy for VRChat.
...
app = FastAPI(
    title="VRChat BPlayer Proxy — Accel",
    description="Bilibili video proxy for VRChat — HLS streaming with multi-threaded download & preload caching",
    version="2.1.0-accel",
    lifespan=lifespan,
)
